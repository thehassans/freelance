...
import TaskPriorityMatrix from './components/tools/TaskPriorityMatrix';
...
import FullStackTaskTriage from './components/tools/FullStackTaskTriage';
...
import RealTimeContentAnalyzer from './components/tools/RealTimeContentAnalyzer';
...
import FreelanceWealthBuilder from './components/tools/FreelanceWealthBuilder';
...
import HeadlineIdeaEngine from './components/tools/HeadlineIdeaEngine';
      ...
      <AccessGate requiredTier={activeTool?.tier || 'FREE'} toolName={activeTool?.name || ''}>
        {(() => {
          switch (activeTool?.id) {
            ...
            case 'task-prioritizer': return <TaskPriorityMatrix />;
            ...
            case 'task-triage': return <FullStackTaskTriage />;
            ...
            case 'word-counter': return <RealTimeContentAnalyzer />;
            ...
            case 'investment-calc': return <FreelanceWealthBuilder />;
            ...
            case 'idea-gen': return <HeadlineIdeaEngine />;
