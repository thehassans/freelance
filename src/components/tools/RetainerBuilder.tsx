...
import { Anchor, ShieldCheck, Download, Copy, Check, Info, Clock, CreditCard, RotateCw, FileSignature, Briefcase, Upload, Trash2, Palette, PenTool, Share2, ArrowLeft, Lock, Zap, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
      <div className="space-y-6">
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h3 className="text-xl font-bold">Retainer Architect</h3>
            ...
            {viewMode === 'editor' ? (
              <>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {colors.map(c => (
                          <button 
                            ...
                            className={`w-6 h-6 rounded-full border-2 transition-transform hover:scale-110 ${primaryColor === c ? 'border-orange-600 ring-2 ring-orange-600/20' : 'border-transparent'}`}
                  ...
                  <div className="sm:col-span-2 space-y-4">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:border-orange-600 text-sm font-bold"
                        />
                      </div>
                      <div>
                  ...
                  <div>
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:border-orange-600 text-sm font-bold"
                        />
                      </div>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea 
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:border-orange-600 text-sm resize-none"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                      ...
                      <select 
                        ...
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:border-orange-600 text-sm font-bold appearance-none cursor-pointer"
                      >
                ...
                <div className="flex flex-col gap-4 mb-4">
                  {!shareLink ? (
                    <button 
                      ...
                      disabled={saving}
                      className="w-full py-4 bg-orange-600 text-white rounded-xl text-xs font-black uppercase tracking-[0.2em] transition-all shadow-xl shadow-orange-600/20 hover:scale-[1.02] active:scale-95 disabled:opacity-50 flex items-center justify-center gap-3"
                    >
                      {saving ? <Loader2 size={16} className="animate-spin" /> : <Zap size={16} />} 
                      {saving ? 'Encrypting...' : 'Save & Create Share Link'}
                    </button>
                  ) : (
                    <div className="p-3 bg-slate-900 rounded-xl flex items-center overflow-hidden border border-slate-800">
                       <div className="flex-grow ps-3 text-[10px] font-mono text-slate-400 truncate">{shareLink}</div>
                       <button 
                         onClick={() => {
                  ...
                  <div className="flex gap-4">
                    <div className="flex-grow">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:border-orange-600 text-sm font-bold font-cursive"
                          value={signatureName || ''}
                    ...
                    <div className="pt-6">
                      <button 
                        ...
                        className="h-[46px] px-6 bg-slate-100 text-slate-600 rounded-xl text-xs font-black flex items-center justify-center gap-2 hover:bg-slate-200 transition-all active:scale-95"
                      >
                        <Share2 size={18} /> Preview
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8 min-h-[500px]">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-sm font-black uppercase tracking-widest text-slate-400">Client Signing Gate</span>
                </div>
                ...
                <div className="p-6 bg-orange-50 rounded-3xl border border-orange-100">
                   ...
                   <p className="text-xs text-orange-700 leading-relaxed">
                       Review your retainer details on the right. If everything is correct, sign below to activate the recurring service.
                   </p>
                </div>
                ...
                {isLocked ? (
                  <div className="p-12 text-center space-y-4">
                     ...
                     <button 
                       onClick={() => setViewMode('editor')}
                       className="px-8 py-3 bg-slate-900 text-white rounded-xl text-xs font-black shadow-lg"
                     >
                       Return to Editor
                     </button>
                  </div>
      ...
      <div className="sticky top-24">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="border-b border-slate-300 pb-2 mb-2 h-16 flex items-end">
                      {clientSignature ? (
                        ...
                        <div className="w-full h-full border-2 border-dashed border-slate-50 rounded flex items-center justify-center">
                           <span className="text-[8px] text-slate-200 uppercase font-black">Awaiting e-Signature</span>
                        </div>
                      )}
                    </div>
        ...
        <div className="mt-4 p-4 bg-orange-50 border border-orange-100 rounded-2xl flex items-start gap-4">
           ...
           <div>
             ...
             <p className="text-[10px] text-orange-700 leading-relaxed md:text-xs">
